...
import ec.edu.sga.facade.HorarioFacade;
...
public class HorarioController implements Serializable {
    ...
    @EJB
    private ec.edu.sga.facade.HorarioFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            SessionUtil.agregarMensajeInformacion(ResourceBundle.getBundle("/Bundle").getString("HorarioCreated"));
    ...
    public String update() {
        try {
            ...
            SessionUtil.agregarMensajeInformacion(ResourceBundle.getBundle("/Bundle").getString("HorarioUpdated"));
            return "View";
        } catch (Exception e) {
            SessionUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            SessionUtil.agregarMensajeInformacion(ResourceBundle.getBundle("/Bundle").getString("HorarioDeleted"));
        } catch (Exception e) {
            SessionUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
