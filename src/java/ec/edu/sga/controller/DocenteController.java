...
public class DocenteController implements Serializable {
    ...
    @EJB
    private ec.edu.sga.facade.DocenteFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            SessionUtil.agregarMensajeInformacion(ResourceBundle.getBundle("/Bundle").getString("DocenteCreated"));
    ...
    public String update() {
        try {
            ...
            SessionUtil.agregarMensajeInformacion(ResourceBundle.getBundle("/Bundle").getString("DocenteUpdated"));
            return "View";
        } catch (Exception e) {
            SessionUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            SessionUtil.agregarMensajeInformacion(ResourceBundle.getBundle("/Bundle").getString("DocenteDeleted"));
        } catch (Exception e) {
            SessionUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
