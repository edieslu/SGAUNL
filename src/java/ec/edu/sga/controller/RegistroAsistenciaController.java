...
@Named("registroAsistenciaController")
@SessionScoped
public class RegistroAsistenciaController implements Serializable {

    private RegistroAsistencia current;
    private DataModel items = null;
    @EJB
    private ec.edu.sga.facade.RegistroAsistenciaFacade ejbFacade;
    ...
    public RegistroAsistencia getSelected() {
        if (current == null) {
            current = new RegistroAsistencia();
            selectedItemIndex = -1;
        }
        return current;
    }

    private RegistroAsistenciaFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (RegistroAsistencia) getItems().getRowData();
    ...
    public static class RegistroAsistenciaControllerConverter implements Converter {

        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            if (value == null || value.length() == 0) {
                return null;
            }
            RegistroAsistenciaController controller = (RegistroAsistenciaController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "registroAsistenciaController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof RegistroAsistencia) {
                RegistroAsistencia o = (RegistroAsistencia) object;
                return getStringKey(o.getId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + RegistroAsistencia.class.getName());
            }
        }
    }
}
